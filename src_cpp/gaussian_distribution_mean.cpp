...
int main(int argc, char *argv[]) {
  ...
  desc.add_options()("help", "Gaussian distribution analyzed by Renyi entropy")(
      ...
      "Dimension")(
      "neighborhood",
      boost::program_options::value<unsigned int>()->default_value(21),
      "Maximal neighborhood")(
      "metric", boost::program_options::value<double>()->default_value(2),
      "Metric")(
      "method",
      boost::program_options::value<std::string>()->default_value(methods[0]),
      "Method")("random",
                boost::program_options::value<std::string>()->default_value(
                    random_noise_types[0]),
                "Random noise")(
      "sample",
      boost::program_options::value<unsigned int>()->default_value(1000),
      "Sample size")("multithreading", "Multithreading");
